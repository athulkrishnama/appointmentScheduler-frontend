...
function CancelConfirmationModal({ isOpen, onClose, appointmentId, onSuccess }) {
    ...
    const handleCancel = async () => {
        try {
            ...
            const response = await axios.patch(`/client/cancelAppointment/${appointmentId}`, { reason: cancellationReason });
                        ...
                        >
                            ...
                            <div className="mb-4">
                                ...
                                <select
                                    ...
                                    className="w-full px-3 py-2 my-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
                                >
