    ...
    <div>
      ...
      >
        <motion.div
          ...
          exit={{ scale: 0.8 }}
        >
          <button onClick={() => setShowCreateService(false)} className="absolute top-4 right-4 text-gray-700 hover:text-gray-900 z-10">
            <MdClose size={24} />
          </button>
          <h2 className="text-3xl font-bold mb-4 text-center">Create a Service</h2>
          <Formik
                ...
                <Form>
                  <div className='flex gap-3'>
                    ...
                    <div className='w-[90%] md:w-[80%] flex flex-col items-center border border-gray-300 p-4 rounded-2xl'>
                      <img src={image ? URL.createObjectURL(image) : defaultBanner} alt="" className='rounded aspect-[3/1]' />
                  ...
                  <div className='flex gap-3 my-4 items-end justify-center'>
                    ...
                    <button type='button' onClick={addNewField} className="bg-black text-white px-6 py-1 rounded hover:bg-gray-800">Add</button>
                  </div>
                  <div className='w-[90%] md:w-[80%] mx-auto'>
                    <table className="min-w-full bg-white border border-gray-200 rounded-lg mt-4">
                      <thead>
                        <tr className="bg-gray-100 text-left">
                          <th className="py-2 px-4 border-b border-r w-[70%]">Field Name</th>
                      ...
                      <tbody>
                        {additionlDetails.map((detail, index) => (
                          <tr key={index} className="hover:bg-gray-50">
                            <td className="py-2 px-4 border-b border-r w-[70%]">{detail.fieldName}</td>
